products = [
 ...
 products.forEach(p=>console.log(p_name))
  ...
  products.sort((p1,p2)=>p2.price-p1.price).forEach(console.log(p))


  // # print costly mobile
var costly_mobile=products.reduce((p1,p2)=>p1.price>p2.price?p1:p2)
